...
public class ProductTypeApi {
	...
	@GetMapping(value = {"/private/product/types", "/private/products/types"}, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@GetMapping(value = {"/private/product/type/{id}", "/private/products/type/{id}"}, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@PostMapping(value = {"/private/product/type", "/private/products/type"}, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@PutMapping(value = {"/private/product/type/{id}", "/private/products/type/{id}"}, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@DeleteMapping(value = {"/private/product/type/{id}", "/private/products/type/{id}"}, produces = MediaType.APPLICATION_JSON_VALUE)
